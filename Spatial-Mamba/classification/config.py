...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'spatial_mamba'
# Model name
_C.MODEL.NAME = 'spatial_mamba_tiny'
...
# SPATIALMAMBA parameters
_C.MODEL.SPATIALMAMBA = CN()
_C.MODEL.SPATIALMAMBA.PATCH_SIZE = 4
_C.MODEL.SPATIALMAMBA.IMAGE_SIZE = 224
_C.MODEL.SPATIALMAMBA.IN_CHANS = 3
_C.MODEL.SPATIALMAMBA.DEPTHS = [2, 4, 8, 4]
_C.MODEL.SPATIALMAMBA.EMBED_DIM = 64
_C.MODEL.SPATIALMAMBA.D_STATE = 16
_C.MODEL.SPATIALMAMBA.MLP_RATIO = 4.0
_C.MODEL.SPATIALMAMBA.DT_INIT = 'random'
